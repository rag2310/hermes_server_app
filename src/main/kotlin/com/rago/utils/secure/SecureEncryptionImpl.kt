...
class SecureEncryptionImpl(private val password: String) : SecureEncryption {
    companion object {
    ...
    override fun encryptString(plaintext: String/*, password: String*/): String {
    ...
    override fun decryptString(base64CiphertextAndNonceAndSalt: String/*, password: String*/): String {
        // Decode the base64.
